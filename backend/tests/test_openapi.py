...
def test_openapi_schema_generation():
    ...
    assert (
        "APISuccessEnvelope_Configuration_" in components
        or "APISuccessEnvelope_List_Configuration__" in components
        or any("APISuccessEnvelope" in k for k in components.keys())
    )
