from app.models.domain import BOMOrigin, ConfigurationMutation, ProductCatalogue
...
def test_bom_traceability(sample_configuration):
    catalogue = ProductCatalogue(
        ...
        mappings=[
            {
                "id": "M-1",
                "feature_option_id": "OPT-MOT-100",
                "component_id": "C-MOT-100",
                "quantity": 1,
                "active": True,
            }
        ],
    ...
    sample_configuration.resolved_components = [
        "C-MOT-100",
        "C-DEP-1",
        "C-RUL-1",
        "C-MAN-1",
