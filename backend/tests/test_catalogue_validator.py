...
def write_stubs(directory: Path, overrides: dict = None) -> None:
    ...
    stubs = {
        ...
        "categories.json": [
            {"id": "CAT-A", "name": "A", "description": "desc", "active": True, "metadata": {}}
        ],
        "feature_groups.json": [
            {"id": "GRP-1", "name": "Grp", "description": "desc", "display_order": 1, "active": True}
        ],
        "features.json": [
            {"id": "F-1", "name": "Feat", "description": "desc", "category_id": "CAT-A", "group_id": "GRP-1", "required": True, "configurable": True, "active": True, "metadata": {}}
        ],
        "feature_options.json": [
            {"id": "OPT-1", "feature_id": "F-1", "display_name": "Opt1", "internal_value": 1, "description": "", "active": True, "metadata": {}}
        ],
        "components.json": [
            {"id": "COMP-1", "name": "Comp1", "description": "", "category": "Mechanical", "manufacturer": "Gen", "unit": "pcs", "specifications": {}, "active": True, "metadata": {}}
        ],
        "feature_mappings.json": [
            {"id": "MAP-1", "feature_option_id": "OPT-1", "component_id": "COMP-1", "quantity": 1, "action": "ADD", "active": True}
        ],
        "dependencies.json": [
            {"id": "DEP-1", "source_id": "OPT-1", "target_id": "COMP-1", "dependency_type": "REQUIRES", "description": "", "priority": 100, "condition_expression": None}
        ],
        "rules.json": [],
        "pricing.json": {},
    }
...
def test_validator_catches_duplicate_id(tmp_path: Path, temp_loader: DataLoader):
    ...
    cat_data = [
        {"id": "CAT-A", "name": "A", "description": "desc", "active": True, "metadata": {}},
        {"id": "CAT-A", "name": "B", "description": "desc", "active": True, "metadata": {}}
    ]
...
def test_validator_catches_schema_validation_failure(tmp_path: Path, temp_loader: DataLoader):
    comp_data = [
        {"id": "COMP-1", "name": "Comp1", "description": "", "category": "INVALID_CATEGORY", "manufacturer": "Gen", "unit": "pcs", "specifications": {}, "active": True, "metadata": {}}
    ]
...
def test_validator_catches_invalid_feature_category_fk(tmp_path: Path, temp_loader: DataLoader):
    feat_data = [
        {"id": "F-1", "name": "Feat", "description": "desc", "category_id": "BAD-CAT", "group_id": "GRP-1", "required": True, "configurable": True, "active": True, "metadata": {}}
    ]
...
def test_validator_catches_invalid_dependency_fk(tmp_path: Path, temp_loader: DataLoader):
    dep_data = [
        {"id": "DEP-1", "source_id": "OPT-1", "target_id": "BAD-COMP", "dependency_type": "REQUIRES", "description": "", "priority": 100, "condition_expression": None}
    ]
...
def test_validator_catches_inactive_reference(tmp_path: Path, temp_loader: DataLoader):
    ...
    cat_data = [
        {"id": "CAT-A", "name": "A", "description": "desc", "active": False, "metadata": {}}
    ]
    write_stubs(tmp_path, overrides={"categories.json": cat_data})
