...
def test_export_api_json(client: TestClient, sample_configuration):
    ...
    response = client.get(f"/api/v1/configurations/{sample_configuration.configuration_id}/export/json")
...
def test_export_api_pdf(client: TestClient, sample_configuration):
    client.app.state.store.create(sample_configuration)
    response = client.get(f"/api/v1/configurations/{sample_configuration.configuration_id}/export/pdf")
...
def test_export_api_quote(client: TestClient, sample_configuration):
    ...
    client.app.state.store.create(sample_configuration)
    response = client.get(f"/api/v1/configurations/{sample_configuration.configuration_id}/quote")
