...
def empty_catalogue():
    return ProductCatalogue(
        ...
        feature_options=[
            FeatureOption(
                id="OPT_1", feature_id="F1", display_name="O1", internal_value="1"
            ),
            FeatureOption(
                id="OPT_2", feature_id="F1", display_name="O2", internal_value="2"
            ),
            FeatureOption(
                id="OPT_3", feature_id="F1", display_name="O3", internal_value="3"
            ),
        ],
        mappings=[],
        dependencies=[],
