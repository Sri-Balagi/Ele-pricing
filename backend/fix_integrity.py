...
new_groups = [
    { "id": "GRP-B-CORE", "name": "Core Parameters", "description": "Core elevator configuration.", "display_order": 1, "active": True },
    { "id": "GRP-B-CTRL", "name": "Control Systems", "description": "Control systems.", "display_order": 4, "active": True },
    { "id": "GRP-B-MECH", "name": "Mechanical Systems", "description": "Mechanical options.", "display_order": 5, "active": True }
]
...
failed_options = ["OPT-B-DOOR-CO", "OPT-B-DOOR-SO", "OPT-B-FIN-SS", "OPT-B-FIN-GLS", "OPT-B-DEST-CONV", "OPT-B-GRP-STD"]
